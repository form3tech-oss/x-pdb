...
var file_disruptionprobe_v1_disruptionprobe_proto_rawDesc = string([]byte{
...
var (
	...
	file_disruptionprobe_v1_disruptionprobe_proto_rawDescData []byte
)
...
func file_disruptionprobe_v1_disruptionprobe_proto_rawDescGZIP() []byte {
	file_disruptionprobe_v1_disruptionprobe_proto_rawDescOnce.Do(func() {
		file_disruptionprobe_v1_disruptionprobe_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_disruptionprobe_v1_disruptionprobe_proto_rawDesc), len(file_disruptionprobe_v1_disruptionprobe_proto_rawDesc)))
	})
...
func file_disruptionprobe_v1_disruptionprobe_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_disruptionprobe_v1_disruptionprobe_proto_rawDesc), len(file_disruptionprobe_v1_disruptionprobe_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
